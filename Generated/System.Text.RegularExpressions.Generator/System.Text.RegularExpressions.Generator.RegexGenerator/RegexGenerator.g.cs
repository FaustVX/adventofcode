...
namespace AdventOfCode.Model
{
    partial class Calendar
    {
        ...
        /// </code>
        /// </remarks>
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Text.RegularExpressions.Generator", "11.0.14.16012")]
...
namespace System.Text.RegularExpressions.Generated
{
    ...
    [GeneratedCodeAttribute("System.Text.RegularExpressions.Generator", "11.0.14.16012")]
            ...
            private sealed class Runner : RegexRunner
            {
                ...
                private bool TryFindNextPossibleStartingPosition(ReadOnlySpan<char> inputSpan)
                {
                    ...
                    if ((uint)pos < (uint)inputSpan.Length)
                    {
                        ...
                        int i = inputSpan.Slice(pos).IndexOfAny(Utilities.s_asciiDigitsAndDot);
                        if (i >= 0)
                        {
                ...
                private bool TryMatchAtCurrentPosition(ReadOnlySpan<char> inputSpan)
                {
                    ...
                    {
                        int iteration = slice.IndexOfAnyExcept(Utilities.s_asciiDigitsAndDot);
                        if (iteration < 0)
                        {
    ...
    file static class Utilities
    {
        ...
        internal static readonly SearchValues<char> s_asciiDigitsAndDot = SearchValues.Create(".0123456789");
